...
class Aplicacion:
    ...
    def tabla(self):
        ...
        self.labelTabla = Label(self.ventana1,text="Tabla cargada exitosamente!!",bg="green").place(x=10,y=150)
    ...
    def agregar_opciones(self):
        ...
        self.labelTabla=Label(self.ventana1,text="Tabla no cargada",bg="red").place(x=10,y=150)
    ...
    def siguiente(self):
        if self.carga and self.cargaTabla:
        	...
        	messagebox.showinfo(message="Por favor cargue un archivo en formato fasta y una tabla de coordenadas", title="Archivo no Cargado")
